...
| **Pourquoi 20 lignes ne sont pas faisables** | `mapping_8_verrous.md` | Le classement des 56 (déjà fait / existe / développable / LIMITE) et les **8 verrous** (7 racines et un symptôme composé) auxquels 19 des 20 LIMITE se ramènent, chacun avec les mesures qui l'établissent. |
